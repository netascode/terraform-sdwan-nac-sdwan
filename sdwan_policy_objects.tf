...
resource "sdwan_policy_object_unified_url_filtering" "policy_object_unified_url_filtering" {
  ...
  block_page_contents   = each.value.block_page_action == "text" ? try(each.value.block_page_content_body, null) != null ? "${local.defaults.sdwan.feature_profiles.policy_object_profile.security_url_filtering_profiles.block_page_content_header} ${each.value.block_page_content_body}" : "${local.defaults.sdwan.feature_profiles.policy_object_profile.security_url_filtering_profiles.block_page_content_header} ${local.defaults.sdwan.feature_profiles.policy_object_profile.security_url_filtering_profiles.block_page_content_body}" : null
