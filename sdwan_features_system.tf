...
resource "sdwan_system_omp_feature" "system_omp_feature" {
  ...
  site_types                           = try(each.value.omp.site_types_for_transport_gateway, null)
  site_types_variable                  = try("{{${each.value.omp.site_types_for_transport_gateway_variable}}}", null)
