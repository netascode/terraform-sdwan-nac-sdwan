...
resource "sdwan_cisco_system_feature_template" "cisco_system_feature_template" {
  ...
  geo_fencing_sms_phone_numbers = try(each.value.geo_fencing_sms_phone_numbers.number, each.value.geo_fencing_sms_phone_numbers.number_variable, null) == null ? null : [{
  ...
  trackers = try(length(each.value.endpoint_trackers) == 0, true) ? null : [for obj in each.value.endpoint_trackers : {
    ...
    interval          = try(obj.interval, null)
    ...
    multiplier          = try(obj.multiplier, null)
    ...
    threshold                            = try(obj.threshold, null)
...
resource "sdwan_cisco_vpn_interface_feature_template" "cisco_vpn_interface_feature_template" {
  ...
  ip_mtu                                        = try(each.value.mtu, null)
  ...
  #tunnel_bandwidth                      = try(each.value.tunnel_interface.bandwidth, null)
  #tunnel_bandwidth_variable             = try(each.value.tunnel_interfacebandwidth_variable, null)
  ...
  #tunnel_interface_control_connections           = try(each.value.tunnel_interface.max_control_connections, null)
  #tunnel_interface_control_connections_variable  = try(each.value.tunnel_interface.max_control_connections_variable, null)
...
resource "sdwan_switchport_feature_template" "switchport_feature_template" {
  ...
  interfaces = try(length(each.value.interfaces) == 0, true) ? null : [for interface in try(each.value.interfaces, []) : {
    ...
    dot1x_voice_vlan                                  = try(interface.voice_vlan, null)
    dot1x_voice_vlan_variable                         = try(interface.voice_vlan_variable, null)
