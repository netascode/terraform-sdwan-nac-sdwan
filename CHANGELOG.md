...
- add support for `trustsec_trusted` in service LAN VPN ethernet interface (`sdwan_service_lan_vpn_interface_ethernet_feature`), only sent when `trustsec_propogate` is `true`
